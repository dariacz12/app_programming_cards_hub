  ...
  const cardsPhotos = [
    ...
    const categoriesPhotos = [
        ...
        {id: '4',
         ...
         {id: '8',
          src: require('../../assets/categorycard8.png'),
            text:"Eventy"
         },   
    ];
          ...
          <View className="mt-2 mx-10">
            ...
            <View className="items-start ml-6 my-8">
              ...
              <View className='flex w-full justify-center mb-4 flex-wrap flex-row'>
                {categoriesPhotos.map(({src, text})=>{return <CategoryElement text={text}>{src}</CategoryElement>})}

              </View>
            <InfoCard welcomeScreen={false}>
                <Text className="leading-5 text-base text-secondary px-4">
                Programujesz w JavaScript? 👨‍💻 A może dopiero myślisz o pracy jako Front-end developer? 
                🚀 Według nas niezależnie od doświadczenia i stanowiska warto rozwijać swoją wiedzę, gdyż to ona jest w cenie! 📖
 {"\n"}Z naszymi kartami:
 {"\n"}🚀 Poznasz lepiej swoje narzędzie pracy. W przypadku programisty najcenniejsza jest wiedza!
{"\n"}🚀 Zobaczysz, jak działa JavaScript! Pojęcia typu: Call Stack, Stack, Event Queue, IFEE, Closure, Event Capturing, dziedziczenie prototypowe czy też mutacja danych nie będą więcej Ci obce!
{"\n"}🚀 Przygotujesz się do technicznej części rozmowy rekrutacyjnej.
{"\n"}🚀 Poznasz zagadnienia często pomijane w kursach i tutorialach
{"\n"}🚀 Przetestujesz przykłady bez przepisywania kodu! Wystarczy zeskanować kod QR z karty.
                </Text>
            </InfoCard>
              ...
              <View style={styles.centeredView}>
                <TouchableWithoutFeedback onPress={() => setModalVisible(true)}>
                  ...
                  >
                    ...
                    Po zakupie wybranych kart na naszej stronie internetowej sprawdź swoją skrzynkę pocztową. Znajdziesz tam kod aktywacyjny.
                    </Text>
                  </LinearGradient>
